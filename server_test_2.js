...
const KERAMRUTH_ERP_DOMAIN_NAME = KERAMRUTH_DOMAIN_NAME === 'innogenxtech.com' ? KERAMRUTH_DOMAIN_NAME : `erp.${KERAMRUTH_DOMAIN_NAME}`
...
const corsOptions = {
  origin: [`https://${KERAMRUTH_DOMAIN_NAME}`, `https://${KERAMRUTH_ERP_DOMAIN_NAME}`,],
...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', `https://${KERAMRUTH_ERP_DOMAIN_NAME}`); // Allow only the frontend domain
  res.header('Access-Control-Allow-Credentials', 'true'); // Allow cookies
  res.header('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS'); // Allow methods
  res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, Access-Control-Allow-Origin'); // Allow headers
  next();
});
...
// const corsOptions = {
//      origin: ['https://${KERAMRUTH_DOMAIN_NAME}', 'https://api.${KERAMRUTH_DOMAIN_NAME}', 'http://${KERAMRUTH_DOMAIN_NAME}'],
//     methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
//     allowedHeaders: ['Content-Type', 'Authorization', 'Access-Control-Allow-Origin'],
//     credentials: true, // Allow cookies if needed
//     preflightContinue: false,
...
// app.use((req, res, next) => {
//   res.header('Access-Control-Allow-Origin', 'https://${KERAMRUTH_DOMAIN_NAME}'); // Allow only the frontend domain
//   res.header('Access-Control-Allow-Credentials', 'true'); // Allow cookies
//   res.header('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS'); // Allow methods
//   res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, Access-Control-Allow-Origin'); // Allow headers
//   next();
...
// const io = new Server(server, {
//     cors: {
//         origin: ['https://${KERAMRUTH_DOMAIN_NAME}'],
//         methods: ['GET', 'POST'],
//     }
// });

// const corsOptions = {
//     origin: ['https://${KERAMRUTH_DOMAIN_NAME}'], // Allow local development URL and API URL
