...
var _require = require('../../models'),
  User = _require.User; // Import the User model 
...
var sendForgotPasswordLink = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var email, user, resetToken, expirationTime, resetLink, transporter, mailOptions;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          resetToken = crypto.randomBytes(20).toString('hex'); // Store reset token and expiration time (10 minutes from now)
          expirationTime = Date.now() + 10 * 60 * 1000; // 10 minutes from now
        ...
        case 13:
          ...
          resetLink = "http://88.222.245.236/create-password?token=".concat(resetToken); // Configure Nodemailer transporter
          ...
          mailOptions = {
            ...
            html: "<p>Click the link below to reset your password. It will expire in 10 minutes:</p><a href=\"".concat(resetLink, "\">").concat(resetLink, "</a>")
          }; // Send email
          _context.next = 18;
  ...
  return function sendForgotPasswordLink(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, email, token, password, user, currentTime, encryptedPassword, updateUser, fullName, transporter, mailOptions;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 19:
          ...
          mailOptions = {
            ...
            html: "<p>Hello ".concat(fullName, ",</p><p>Your password has been successfully updated. If this was not you, please contact support immediately.</p>")
          };
          _context2.prev = 22;
          _context2.next = 25;
          return transporter.sendMail(mailOptions);
        ...
        case 34:
          ...
          console.error('Error updating password:', _context2.t1);
          return _context2.abrupt("return", res.status(500).json({
            message: 'Internal server error.'
          }));
        case 38:
