...
var _require = require('../../../models'),
  Announcement = _require.Announcement,
  User = _require.User,
  Notification = _require.Notification;
var _require2 = require('sequelize'),
  Op = _require2.Op;
exports.getAnnouncements = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var role_name, _announcements, whereClause, announcements;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          role_name = req.user.role_name; // Assume role_name is available in req.user
...
exports.getByIdAnnouncement = /*#__PURE__*/function () {
...
exports.createAnnouncement = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, documentID, heading, description, link, receiver, announcement, parsedReceiver, users, notifications;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _req$body = req.body, documentID = _req$body.documentID, heading = _req$body.heading, description = _req$body.description, link = _req$body.link, receiver = _req$body.receiver;
        ...
        case 12:
          ...
          notifications = users.map(function (user) {
            return {
              user_id: user.id,
              message: "New Announcement is recived:: ".concat(heading),
              is_read: false,
              created_at: new Date(),
              detail: {
                link: link,
        ...
        case 19:
          ...
          console.error('Error creating announcement:', _context3.t0);
...
exports.updateByIdAnnouncement = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, _req$body2, documentID, heading, description, link, receiver, announcement;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          id = req.params.id;
          _req$body2 = req.body, documentID = _req$body2.documentID, heading = _req$body2.heading, description = _req$body2.description, link = _req$body2.link, receiver = _req$body2.receiver;
          _context4.prev = 2;
          _context4.next = 5;
          return Announcement.findByPk(id);
        case 5:
          announcement = _context4.sent;
          if (announcement) {
            _context4.next = 8;
            break;
          }
        ...
        case 21:
          ...
          console.error('Error updating announcement:', _context4.t0);
...
exports.deleteByIdAnnouncement = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 9:
          ...
          req.io.emit('delete_announcement', {
            id: id
          });
