...
var _require = require('../../models'),
  ...
  User = _require.User,
  OrderLimit = _require.OrderLimit; // Import necessary models

// Function to update assigned orders
var updateAssignedOrders = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var orderLimitRecord, timeLimit, pendingOrders, _iterator, _step, order, user, superiorId, requestedByRole;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          orderLimitRecord = _context.sent;
          ...
          timeLimit = new Date(Date.now() - 24 * 60 * 60 * 1000); // Calculate time limit
        ...
        case 7:
          ...
          _iterator = _createForOfIteratorHelper(pendingOrders);
          _context.prev = 9;
          _iterator.s();
        case 11:
        ...
        case 16:
          ...
          superiorId = user.superior_id; // Get the superior ID
          if (!superiorId) {
            _context.next = 25;
            break;
          }
        ...
        case 27:
          console.log("Order no ".concat(order.id, " cancelled as user has no superior."));
        case 28:
          // Check if requested_by_role is "Area Development Officer"
          requestedByRole = order.requested_by_role; // Adjust if needed
        ...
        case 48:
          ...
          console.error('Error updating orders:', _context.t1.message);
        case 51:
        case "end":
          return _context.stop();
      }
    }, _callee, null, [[0, 48], [9, 40, 43, 46]]);
  }));
...
exports.fetchOrders = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          userId = 326; // Get the logged-in user's ID from req.user
